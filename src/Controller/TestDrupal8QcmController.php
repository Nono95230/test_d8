...
class TestDrupal8QcmController extends ControllerBase {
  ...
  protected $formBuilderNamespace;
	...
	public function __construct(PrivateTempStoreFactory $session, Request $request, TimeInterface $currentTime, ConfigFactory $configFactory, FormBuilderInterface $formBuilder){
